...
> Last updated: 2026-05-04 07:04:22 UTC
...
- [![PR #2007](https://img.shields.io/badge/PR%20%232007-draft-gray)](https://github.com/openshift/oadp-operator/pull/2007) **openshift/oadp-operator** → `oadp-dev` - refactor(e2e): migrate to external oadp-must-gather container image
...
- [![PR #8](https://img.shields.io/badge/PR%20%238-ready-green)](https://github.com/us/mocker/pull/8) **us/mocker** → `main` - feat: implement Docker/Podman socket compatibility via launchd activation
