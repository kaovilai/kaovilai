...
- [![PR #2445](https://img.shields.io/badge/PR%20%232445-waiting--merge-blue)](https://github.com/openshift/oadp-operator/pull/2445) **openshift/oadp-operator** → `oadp-dev` - fix: don't check VEP-25 CRDs before the feature gate that creates them
