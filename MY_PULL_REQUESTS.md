...
> Last updated: 2026-05-07 20:33:25 UTC
...
- [![PR #2007](https://img.shields.io/badge/PR%20%232007-ready-green)](https://github.com/openshift/oadp-operator/pull/2007) **openshift/oadp-operator** → `oadp-dev` - refactor(e2e): migrate to external oadp-must-gather container image
...
- [![PR #2196](https://img.shields.io/badge/PR%20%232196-ready-green)](https://github.com/openshift/oadp-operator/pull/2196) **openshift/oadp-operator** → `oadp-dev` - docs: add podConfig documentation for tolerations, nodeSelector, labels, and env
