...
> Last updated: 2026-08-04 23:06:13 UTC
...
- [![PR #2353](https://img.shields.io/badge/PR%20%232353-ready-green)](https://github.com/openshift/oadp-operator/pull/2353) **openshift/oadp-operator** → `oadp-dev` - Fix DPA reconcile race: use MergeFrom patch for status update
...
- [![PR #2352](https://img.shields.io/badge/PR%20%232352-waiting--merge-blue)](https://github.com/openshift/oadp-operator/pull/2352) **openshift/oadp-operator** → `oadp-dev` - Add datadownloads RBAC to kubevirt-datamover ClusterRole
- [![PR #2350](https://img.shields.io/badge/PR%20%232350-draft-gray)](https://github.com/openshift/oadp-operator/pull/2350) **openshift/oadp-operator** → `oadp-dev` - Add e2e coverage for kubevirt-datamover: multi-PVC VMs and incremental backup sequence
...
- [![PR #307](https://img.shields.io/badge/PR%20%23307-ready-green)](https://github.com/migtools/oadp-non-admin/pull/307) **migtools/oadp-non-admin** → `oadp-dev` - Document usage of NADR (NonAdminDownloadRequest) feature
...
- [![PR #1](https://img.shields.io/badge/PR%20%231-draft-gray)](https://github.com/kaovilai/kubevirt-datamover-controller/pull/1) **kaovilai/kubevirt-datamover-controller** → `issue-73-phase3-datadownload-controller` - fix: enforce Spec.OperationTimeout in DataUpload/DataDownload controllers
