...
> Last updated: 2026-08-25 15:47:41 UTC
...
- [![PR #10276](https://img.shields.io/badge/PR%20%2310276-ready-green)](https://github.com/velero-io/velero/pull/10276) **velero-io/velero** → `main` - Fail fast with clear error when data mover pod is unschedulable (milestone: **v1.19**)
...
- [![PR #10077](https://img.shields.io/badge/PR%20%2310077-ci--pending-yellow)](https://github.com/velero-io/velero/pull/10077) **velero-io/velero** → `main` - Add Dependabot auto-approve workflow
...
- [![PR #10390](https://img.shields.io/badge/PR%20%2310390-ci--pending-yellow)](https://github.com/velero-io/velero/pull/10390) **velero-io/velero** → `main` - Skip kind e2e matrix entries for kindest/node tags with missing manifests
...
- [![PR #10399](https://img.shields.io/badge/PR%20%2310399-draft-gray)](https://github.com/velero-io/velero/pull/10399) **velero-io/velero** → `release-1.17` - [Backport release-1.17] Fix e2e kind matrix misparsing pre-release node tags
...
- [![PR #50](https://img.shields.io/badge/PR%20%2350-waiting--merge-blue)](https://github.com/migtools/kubevirt-datamover-plugin/pull/50) **migtools/kubevirt-datamover-plugin** → `oadp-dev` - Set binding-blocking spec.selector on restore-target PVCs
